    ...
    form.forEach((field) => {
        ...
        switch(field.type) {
            case INPUT.USER:
                ...
                errorMsgs = {
                    type: INPUT.USER,
                    errors: ["Debe contener entre 7 a 15 caracteres",
            ...
            case INPUT.PASSWORD:
                ...
                errorMsgs = { 
                    type: INPUT.PASSWORD,
                    errors: ["Debe contener entre 10 a 30 caracteres",
        ...
        errors = field.string.match(new RegExp(pattern)) ? errors : [...errors, errorMsgs];
    })
