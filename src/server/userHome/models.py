...
class UserHome(models.Model):
    ...
    residenceName = models.CharField(
        max_length=30, null=False, blank=False, verbose_name="Nombre de residencia")

    streetBlockNumber = models.CharField(
        max_length=10, null=False, blank=False, verbose_name="Numero de manzana")

    homeNumber = models.CharField(
        max_length=4, null=False, blank=False, verbose_name="Numero de casa")
